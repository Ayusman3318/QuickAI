import { Edit, Edit2Icon, Edit3, FileEdit, Hash, Sparkles } from 'lucide-react'
...
const styleCategories = [
  ...
  const[selectedCategory, setSelectedCategory] = useState(styleCategories[0])
  ...
  const onSubmitHandler = async(e) =>{
      ...
      try {
        setLoading(true)
        const prompt = `Generating a blog title for the keyword ${input} in the 
  ...
  return (
    ...
    gap-4 text-slate-700'>
        ...
        border-gray-200'>
          ...
          placeholder='Type your topic, We’ll craft the title.' required/>
          ...
          <div className='mt-2 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center'>
            ...
            styleCategories.map((item) => (
              <span
                ...
                transition-colors duration-200 ${selectedCategory === item ? 'bg-primary text-white' 
