  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='item-center text-center'>
        <h2 className='text-slate-700 text-[42px] font-semibold'>Powerful 
          <span className='text-pretty text-primary'> QuickAI </span>Tools</h2>
        <p className='text-slate-500 max-w-lg mx-auto'>Everything you need to create, enhance and optimize your content!</p>
      </div>
