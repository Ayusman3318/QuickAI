  ...
  return (
    ...
    py-3 px-4 sm:px-20 xl:px-32'>
        <img
          src={assets.logo}
          alt="logo"
          className="w-32 sm:w-44 transition-transform hover:scale-105 duration-300"
          onClick={() => navigate('/')}
        />
        {
          user ? <UserButton/> :(
        <button
          ...
          text-white px-10 py-2.5 text-sm font-semibold hover:shadow-2xl transition hover:scale-3d"
        >
